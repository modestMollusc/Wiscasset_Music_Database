...
- `wisc5G.py`: The Python GUI application using Tkinter for the user interface and psycopg for database connectivity.
...
5. **Run the Application**:
   - Place `wisc5G.py` in your working directory.
...
### Troubleshooting
- **Connection Errors**: Verify DB_CONFIG in `wisc5G.py` matches your setup (host: localhost, dbname: wiscasset, user: your_username, password: your_password).
...
For issues or contributions, refer to the source files or contact the developer, Jim Davis